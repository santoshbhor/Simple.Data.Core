using Simple.Data.Oracle.ManagedDataAccess.Core;
using System.IO;
...
namespace Simple.Data.Oracle.ReflectionSql
{
    public static class SqlLoader
    {
        ...
        private static string LoadFile(string name)
        {
            ...
            return Resources.ResourceManager.GetString(Path.GetFileNameWithoutExtension(name), System.Globalization.CultureInfo.CurrentCulture);
